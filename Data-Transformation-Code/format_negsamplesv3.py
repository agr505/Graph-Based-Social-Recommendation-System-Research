...
for knegsample in knegsamples:
    ...
    #print("intersection ",set(zip(*(train_u,train_v))).intersection(set(zip(*(test_u,test_v) ))))
    #print("intersection ",set(zip(*(val_u,val_v))).intersection(set(zip(*(test_u,test_v) ))))
        ...
        if (userid,tweetid) not in posteritem:
            ...
            if len(followers)<knegsample:
                ...
                while k<knegsample:
                    ...
                    if eligible==True:
                        if (userid,tweetid) in zip(train_u,train_v) :
                ...
                if tweetid in train_v and len(pairedneglist)==knegsample:
                    print("match")
                elif tweetid in val_v or tweetid in test_v:
                    print("match")
                else:
